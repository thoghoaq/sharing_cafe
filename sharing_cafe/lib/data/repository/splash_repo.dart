...
import 'package:sharing_cafe/data/api/api_client.dart';
// import 'package:sharing_cafe/data/model/response/module_model.dart';
...
class SplashRepo {
  ...
  // bool getFirstAccessStatus(String data) => sharedPreferences.getString(AppConstants.firstAccess) != null
  //     && sharedPreferences.getString(AppConstants.firstAccess) == data;
